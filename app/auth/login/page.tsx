  ...
  return (
    <div className="min-h-[calc(100vh-56px)] flex flex-col px-5 pt-10 pb-6 animate-fade-in">
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        <p className="text-[#555] text-sm mt-1">Prijavi se i pronađi igru</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)}
              ...
              className="w-full bg-[#161618] border border-[rgba(255,255,255,.07)] rounded-xl px-4 py-3 pl-10 text-white placeholder-[#444] text-sm focus:outline-none focus:border-orange-500/60 focus:ring-1 focus:ring-orange-500/20 transition-all"/>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input type={showPass ? 'text' : 'password'} value={password}
              ...
              className="w-full bg-[#161618] border border-[rgba(255,255,255,.07)] rounded-xl px-4 py-3 pl-10 pr-11 text-white placeholder-[#444] text-sm focus:outline-none focus:border-orange-500/60 focus:ring-1 focus:ring-orange-500/20 transition-all"/>
      ...
      <div className="flex items-center gap-3 my-7">
        ...
        <span className="text-[#444] text-xs">nemaš nalog?</span>
        <div className="flex-1 h-px bg-[#1e1e1e]"/>
      </div>
